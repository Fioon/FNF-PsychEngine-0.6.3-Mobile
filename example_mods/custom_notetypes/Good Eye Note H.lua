function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Good Eye Note H' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'GOODEYE_assets');
...
function noteMiss(id, noteData, noteType, isSustainNote)
	if noteType == 'Good Eye Note H' then
		setProperty('health',
